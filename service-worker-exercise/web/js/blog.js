(function Blog(){
	...
	initiServiceWorker().catch(console.error);
	...
	// Service worker calling when loading a page.
	async function initiServiceWorker() {
	...
	function onSWMessage(evt) {
		...
		if (data.requestStatusUpdate) {
			console.log("Received status updaterequest from service worker");
